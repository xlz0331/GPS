...
public class AutoGeneratorHelper {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir("D:\\1.workspace\\20171207.generator");
		gc.setFileOverride(true);
		gc.setActiveRecord(true);
		gc.setEnableCache(false);// XML 二级缓存
		gc.setBaseResultMap(true);// XML ResultMap
		gc.setBaseColumnList(false);// XML columList
		gc.setAuthor("xionglz");
		...
		dsc.setUrl("jdbc:mysql://192.168.68.204:3306/hwagain-eagle-db?createDatabaseIfNotExist=true&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&autoReconnect=true&failOverReadOnly=false");
		...
		strategy.setInclude(new String[] { "task"});
...
//		 "info_user_group" });
		...
		pc.setParent("com.hwagain.eagle");

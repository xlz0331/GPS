package com.hwagain.eagle.acquisitionIndictor.entity;
 ...
 * @since 2019-02-20
 */
@TableName("acquisition_indictor")
public class AcquisitionIndictor implements Serializable {
     ...
     * 额外补助单价
     */
	@TableField("extra_subsidy_price")

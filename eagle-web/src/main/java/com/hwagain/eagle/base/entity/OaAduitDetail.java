 ...
 * @since 2019-03-26
 */
@TableName("oa_aduit_detail")
public class OaAduitDetail implements Serializable {
     ...
     * 明细记录的fdid
     */
	@TableField("rec_fd_id")
	private Long recFdId;
    /**
     * 创建人
     */
	...
	public Long getRecFdId() {
		return recFdId;
	}

	public void setRecFdId(Long recFdId) {
		this.recFdId = recFdId;
	}
